...
public class NetworkAuthenticatorFV : NetworkAuthenticator
{
    [Header("Components")]
    ...
    {
        Debug.Log("OnStartClient del NetworkAuthenticator");
    ...
    {
        Debug.Log("OnStartServer del NetworkAuthenticator");

        // registra el mensaje de inicio de sesión, permitido antes de autenticarse
