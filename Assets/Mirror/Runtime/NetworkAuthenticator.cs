...
namespace Mirror
{
    ...
    public abstract class NetworkAuthenticator : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("Mirror tiene un suscriptor interno a este evento. Puede agregar el suyo aquí.")]
        ...
        /// </summary>
        [Tooltip("MMirror tiene un suscriptor interno a este evento. Puede agregar el suyo aquí.")]
        ...
        void OnValidate()
        {
            ...
            if (manager != null && manager.authenticator == null)
            {
                ...
                UnityEditor.Undo.RecordObject(gameObject, "Autenticador de NetworkManager asignado");
            }
#endif
        }
    }
